...
export type CommentFragment = { __typename?: 'Comment', name: string, postId: number } & { ' $fragmentName'?: 'CommentFragment' };

export type PostFragment = { __typename?: 'Post', name: string, comments?: Array<(
    { __typename?: 'Comment' }
    & { ' $fragmentRefs'?: { 'CommentFragment': CommentFragment } }
  )> | null } & { ' $fragmentName'?: 'PostFragment' };

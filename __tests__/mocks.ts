  ...
  return {
    ...
    updatedAt:
      overrides && overrides.hasOwnProperty("updatedAt")
        ? overrides.updatedAt!
        : "2000-03-08T05:06:22.000Z",
  };
};

export const aCreateCommentInput = (
  ...
  return {
    ...
    name:
      overrides && overrides.hasOwnProperty("name")
        ...
        : "veritatis",
    postId:
      overrides && overrides.hasOwnProperty("postId") ? overrides.postId! : 945,
  };
};

export const aCreateCommentPayload = (
  ...
  return {
    clientMutationId:
      overrides && overrides.hasOwnProperty("clientMutationId")
        ...
        : "velit",
    comment:
      overrides && overrides.hasOwnProperty("comment")
        ? overrides.comment!
        : aComment(),
  };
};

export const aCreatePostInput = (
...
export const aCreatePostPayload = (
  ...
  return {
    clientMutationId:
      overrides && overrides.hasOwnProperty("clientMutationId")
        ...
        : "voluptatum",
    post:
      overrides && overrides.hasOwnProperty("post") ? overrides.post! : aPost(),
  };
};
...
export const aMutation = (overrides?: Partial<Mutation>): Mutation => {
  return {
    createComment:
      overrides && overrides.hasOwnProperty("createComment")
        ? overrides.createComment!
        : aCreateCommentPayload(),
    createPost:
